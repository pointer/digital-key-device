...
typedef enum appEvent_tag{
    ...
    mAppEvt_KBD_EventPressPB2_c,
    mAppEvt_KBD_EventLongPB2_c,
    mAppEvt_KBD_EventPressPB3_c,
    ...
    mAppEvt_ConnectionCallback_ReadRssiEvtConnected_c,
    ...
    mAppEvt_Shell_RKELock_Command_c,
    mAppEvt_Shell_RKEUnlock_Command_c,
    mAppEvt_Shell_RKERelease_Command_c,
    mAppEvt_Shell_SetGetBLEParams_Command_c,
    mAppEvt_Shell_ResetAfterDisconnection_Command_c,
    mAppEvt_Shell_SwitchGAPRole_Command_c,
...
typedef struct appRssiReadCallbackEventData_tag
{
    deviceId_t peerDeviceId;
    int8_t rssi_dBm;
} appRssiReadCallbackEventData_t;
